            ...
            <li style="padding-top:8px;">
				<div class="btn-group">
				  <button type="button" class="btn btn-default btn-success dropdown-toggle" data-toggle="dropdown">
					<i class="glyphicon glyphicon-user"></i> ${sessionScope.user.loginacct} <span class="caret"></span>
				  </button>
	...
	<script type="text/javascript" src="${APP_PATH }/jquery/layer/layer.js"></script>
        ...
        <script type="text/javascript">
            ...
            function pageChange(pageno){
            	//window.location.href="${APP_PATH}/user/list_ajax.do?pageNo="+pageno ;
            ...
            function queryPageUser(pageno){
            	...
            	$.ajax({
            		type : "POST",
            		data : jsonObj,
            		url : "${APP_PATH}/user/list_ajax.do",
            		beforeSend : function(){
            ...
            $("#queryBtn").click(function(){
            	...
            	jsonObj.query_loginacct = queryText ;
            	queryPageUser(1);
            });
